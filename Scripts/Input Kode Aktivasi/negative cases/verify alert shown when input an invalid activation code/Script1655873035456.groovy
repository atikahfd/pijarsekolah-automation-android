...
'Verify alert shown above OK button'
Mobile.verifyElementText(findTestObject('Page Activation Code/android.widget.TextView0 - Kode Aktivasi yang Anda masukkan salah'), 
    'Kode Aktivasi yang Anda masukkan salah')
