...
'Verify username in username textbox still remains'
Mobile.verifyElementText(findTestObject('Page Login Parent/android.widget.EditText0 - Username'), username)

'Verify password in password textbox still remains'
Mobile.tap(findTestObject('Page Login Parent/android.view.ViewGroup0 - View Password'), 2)
